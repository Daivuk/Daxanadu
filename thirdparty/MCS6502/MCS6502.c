...
#if defined(_DEBUG)
#define PUSH_PC_HISTORY() \
{ \
    context->pc_history_point++; \
    if (context->pc_history_point == MCS6502_PC_HISTORY_SIZE) \
        context->pc_history_point = 0; \
    context->pc_history[context->pc_history_point] = context->pc; \
}
#else
#define PUSH_PC_HISTORY() {}
#endif
